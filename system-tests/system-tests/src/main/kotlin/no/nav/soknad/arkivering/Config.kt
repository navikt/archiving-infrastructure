...
val defaultProperties = mapOf(
	...
	"KAFKA_INPUT_TOPIC"                      to "privat-soknadinnsending-v1-loadtests",
	"KAFKA_PROCESSING_TOPIC"                 to "privat-soknadinnsending-processingeventlog-v1-loadtests",
	"KAFKA_MESSAGE_TOPIC"                    to "privat-soknadinnsending-messages-v1-loadtests",
	"KAFKA_METRICS_TOPIC"                    to "privat-soknadinnsending-metrics-v1-loadtests",
	"KAFKA_ENTITIES_TOPIC"                   to "privat-soknadinnsending-systemtests-entities",
	"KAFKA_NUMBER_OF_CALLS_TOPIC"            to "privat-soknadinnsending-systemtests-numberofcalls",
